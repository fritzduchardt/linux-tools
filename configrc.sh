...
alias {git-simplecommit-nopush,scP}="lib::exec_linux_tool $script_dir/git simple_commit.sh -M"
alias {git-simplecommit-stage-all,scA}="lib::exec_linux_tool $script_dir/git simple_commit.sh -a -p"
